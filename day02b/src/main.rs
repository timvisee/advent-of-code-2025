...
pub fn main() {
    let count = include_bytes!("../input.txt")
        ...
        .map(|(a, b)| match a {
            a if a >= 1000000000 => m(a, b, 100001) + m(a, b, 101010101) - m(a, b, 1111111111),
            a if a >= 100000000 => m(a, b, 1001001) + m(a, b, 111111111),
            a if a >= 10000000 => m(a, b, 10001) + m(a, b, 11111111),
            a if a >= 1000000 => m(a, b, 1111111),
            a if a >= 100000 => m(a, b, 1001) + m(a, b, 10101) - m(a, b, 111111),
            a if a >= 10000 => m(a, b, 11111),
            a if a >= 1000 => m(a, b, 101),
            a if a >= 100 => m(a, b, 111),
            a if a >= 10 => m(a, b, 11),
            _ => 0,
        })
        .sum::<usize>();
