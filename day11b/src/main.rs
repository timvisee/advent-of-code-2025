...
pub fn main() {
    ...
    println!(
        "{}",
        paths(&fwd, bwd.clone(), *b"dac", *b"fft")
            * paths(&fwd, bwd.clone(), *b"svr", *b"dac")
            * paths(&fwd, bwd.clone(), *b"fft", *b"out")
            + paths(&fwd, bwd.clone(), *b"fft", *b"dac")
                * paths(&fwd, bwd.clone(), *b"svr", *b"fft")
                * paths(&fwd, bwd, *b"dac", *b"out"),
    );
}
