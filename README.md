...
| [day 2](https://adventofcode.com/2025/day/2)   | [`14.12  ms`](./day02a/src/main.rs) | [`24.59  ms`](./day02b/src/main.rs) |

|              | one-by-one (1 CPU core)                   | parallel                                      |
|:-------------|:------------------------------------------|:----------------------------------------------|
| _everything_ | [`39.54  ms`](./runner/src/bin/runner.rs) | [`25.38  ms`](./runner/src/bin/runner-par.rs) |
