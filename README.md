...
|                                                | part A                              | part B                              |
|:-----------------------------------------------|:------------------------------------|:------------------------------------|
| [day 1](https://adventofcode.com/2025/day/1)   | [` 0.022 ms`](./day01a/src/main.rs) | [` 0.026 ms`](./day01b/src/main.rs) |

|              | one-by-one (1 CPU core)                   | parallel                                      |
|:-------------|:------------------------------------------|:----------------------------------------------|
| _everything_ | [` 0.049 ms`](./runner/src/bin/runner.rs) | [` 0.049 ms`](./runner/src/bin/runner-par.rs) |
